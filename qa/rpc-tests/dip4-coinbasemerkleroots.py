...
from test_framework.test_framework import DaidigTestFramework
...
class LLMQCoinbaseCommitmentsTest(DaidigTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as DaidigTestFramework doesn't support this atm)
