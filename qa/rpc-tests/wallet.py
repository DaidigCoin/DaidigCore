...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 DAID from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 DAID in block rewards plus fees, but
        ...
        # Send 100 DAID with subtract fee from amount
        ...
        # Sendmany 100 DAID with subtract fee from amount
