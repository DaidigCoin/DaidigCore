...
* daidig.conf: contains configuration settings for daidigd or daidig-qt
* daidigd.pid: stores the process id of daidigd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by daidigd or daidig-qt
