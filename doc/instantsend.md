...
This mechanism has been integrated into Bitcore-Node-Daidig which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/daidigpay/insight-api-daidig#web-socket-api](https://github.com/daidigpay/insight-api-daidig#web-socket-api)
* API: [https://github.com/daidigpay/insight-api-daidig#instantsend-transactions](https://github.com/daidigpay/insight-api-daidig#instantsend-transactions)
