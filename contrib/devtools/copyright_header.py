...
Arguments:
    <base_directory> - The base directory of a Daidig Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Daidig Core developers'
...
Arguments:
    <base_directory> - The base directory of Daidig Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Daidig Core repository.
"""
