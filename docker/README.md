...
official/supported Docker Images found at https://hub.docker.com/r/daidigpay/daidigd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/daidigpay/daidigd-develop/ when changing the above text**