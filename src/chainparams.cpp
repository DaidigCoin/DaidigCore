 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1580202913, nBits=1e0ffff0, nNonce=6790, vtx=1)
...
{
    const char* pszTimestamp = "Today at 28 January 2020 Daidig Coin Was Born To The World";
    const CScript genesisOutputScript = CScript() << ParseHex("047c4b92260946bdb6b2ed75d1b2fbbbb80203b560723c9dadd0ee1b899808f27f7b6a45ee2643643f2d482b2d2f50d844f1c3ac337a3f5d4267502d7b4906b83b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000019e1ea029f83fdea3598fccd1a1b91d92f11ead8e7bb6c38c6168f1bdb4"); 
        ...
        vAlertPubKey = ParseHex("04a2eb447faa78228658905e9f0e95465e1b01a2a8b0dc04e1c7f5709b194fc324049f1663c526c46137a6bcae586e78a9a6237f1eb35d6c9eb96d37cfe6b53bba");
        nDefaultPort = 15818;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1580202913, 6790, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000019e1ea029f83fdea3598fccd1a1b91d92f11ead8e7bb6c38c6168f1bdb4"));
        assert(genesis.hashMerkleRoot == uint256S("0x07dfdadccc8e432b9fce95dcb6b9f38546f28bca90987d27ef64aeb8ca665a48"));


        vSeeds.push_back(CDNSSeedData("daidigcoin.com", "node1.daidigcoin.com"));
        vSeeds.push_back(CDNSSeedData("n2.daidigcoin.com", "node2.daidigcoin.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Daidig BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Daidig BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Daidig BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"DEX2wmA8aaSYYRWhjLRxmeKfnzjgYUzfx1"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x0000019e1ea029f83fdea3598fccd1a1b91d92f11ead8e7bb6c38c6168f1bdb4"))
        };

        chainTxData = ChainTxData{
            1580202913, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000007f29312ba3c943b9053a07abb8fc7e0e5a9e4d30271156b785c476046a0"); 

        pchMessageStart[0] = 0x2d;
        pchMessageStart[1] = 0x7b;
        pchMessageStart[2] = 0xb7;
        pchMessageStart[3] = 0xad;
        vAlertPubKey = ParseHex("04cdd40e7ac820b02753db7dd56ec0dd2f367f71aa6912e79f8fdf600ee426bdcd9f033f57694ed0cb1f122c1257d9a2fbaceba6d178acabaff83c8372a0d0c721");
        nDefaultPort = 25818;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1580202918UL, 1470150UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000007f29312ba3c943b9053a07abb8fc7e0e5a9e4d30271156b785c476046a0"));
        assert(genesis.hashMerkleRoot == uint256S("0x07dfdadccc8e432b9fce95dcb6b9f38546f28bca90987d27ef64aeb8ca665a48"));
        ...
        // Testnet Daidig BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Daidig BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Daidig BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"EeXAs27tghEmYmjTTVAH3C8LJvtUjMeNh5"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000007f29312ba3c943b9053a07abb8fc7e0e5a9e4d30271156b785c476046a0"))
        };

        chainTxData = ChainTxData{
            1580202918, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1580202923, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x348277342563aee780d9da6d1628650a08ac0f5e85b5ec868731726ac9fffcf3"));
        assert(genesis.hashMerkleRoot == uint256S("0x07dfdadccc8e432b9fce95dcb6b9f38546f28bca90987d27ef64aeb8ca665a48"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("daidigevo.org",  "devnet-seed.daidigevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x348277342563aee780d9da6d1628650a08ac0f5e85b5ec868731726ac9fffcf3"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6Qvjyi91z6xRJyQPcxcV9fvbmk9A7Cb9a3JjWn34hZ45tJraYdy
        vSporkAddresses = {"EWh7LtURV8ZMvoVAKK4o9qNgRBW9aVtNAL"};
        nMinSporkKeys = 1;
        ...
        // Regtest Daidig addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,33);
        // Regtest Daidig script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,34);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,161);
        // Regtest Daidig BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Daidig BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Daidig BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
