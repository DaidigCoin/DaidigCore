...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Daidig address\n"
            "  payee          - Print the masternode payout Daidig address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Daidig address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "daidig",               "masternode",             &masternode,             true,  {} },
    { "daidig",               "masternodelist",         &masternodelist,         true,  {} },
    { "daidig",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "daidig",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
