...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Daidig related functionality
...
/*
    ...
    allow endless transaction that would bloat Daidig and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Daidig specific functionality
