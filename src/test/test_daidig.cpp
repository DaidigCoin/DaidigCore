...
#define BOOST_TEST_MODULE Daidig Test Suite

#include "test_daidig.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_daidig_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
